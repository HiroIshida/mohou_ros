...
def train_and_visualize(
    ...
    if n_pb is not None:
        ...
        additional_option = "-pb {}".format(n_pb)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n_pb", type=int, help="number of parametric bias dimension")
    ...
    if is_testing:
        ...
        train_and_visualize(
            project_path, n_epoch_vae, n_epoch_lstm, n_hidden=400, n_layer=2, n_pb=n_pb
        )
